package com.pineapplemelon.smugglerworlds.actor;
 ...
 */
public class Disparo extends GameActor {
    private Animation animation;
    private float stateTime;

    public Disparo(Body body) {
        super(body);
    ...
    @Override
    public DisparoUserData getUserData() {
        return (DisparoUserData) userData;
    }
