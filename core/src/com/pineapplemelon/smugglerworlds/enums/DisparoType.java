package com.pineapplemelon.smugglerworlds.enums;
...
public enum DisparoType {
    ...
    RUNNING_BIG(2f, 2f, Constants.ENEMY_X, Constants.RUNNING_LONG_ENEMY_Y, Constants.DISPARO_DENSITY,
   ...
   //         Constants.FLYING_WIDE_ENEMY_REGION_NAMES);
    ...
    DisparoType(float width, float height, float x, float y, float density, String[] regions) {
        this.width = width;
        this.height = height;
        this.x = x;
        this.y = y;
